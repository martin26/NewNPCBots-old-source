...
/*
Rogue NpcBot (reworked by Graff onlysuffering@gmail.com) (hackishly further patched for energy regen by Tensix - tensix@gmail.com)
Complete - 25% maybe...
TODO:
*/
#define DMGMIN              1
...
public:
    ...
    struct rogue_botAI : public bot_minion_ai
    {
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            if (energyTickTimer <= diff)	//HACKISH ENERGY REGEN
            {
                modenergy(20);
                energyTickTimer = 2000;
            }
        ...
        void ReduceCD(uint32 diff)
        {
            ...
            if (energyTickTimer > diff)               energyTickTimer -= diff;
        }
